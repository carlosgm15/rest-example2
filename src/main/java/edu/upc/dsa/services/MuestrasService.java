...
public class MuestrasService {
    ...
    public Response getTracks() {
        ...
        List<Muestra> muestras = this.tm.findAllTracks();
    ...
    @Path("/")
    public Response updateTrack(Muestra muestra) {

        Muestra t = this.tm.updateTrack(muestra);
    ...
    public Response newTrack(Muestra muestra) {

        if (muestra.getSinger()==null || muestra.getTitle()==null)  return Response.status(500).entity(muestra).build();
        this.tm.addTrack(muestra);
